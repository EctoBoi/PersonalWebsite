...
function create11x11SignInsert() {
    ...
    //dollor
    ctx.font = dollorsSize + "px " + font;
    ctx.fillText(dollars, canvasWidth / 2 - priceWidth / 2, xToPx("162mm") - o - priceOffset);
...
window.CreateSign = { create2x4HangTag, create3x5HangTag, create4x4FactTag, create4x2Binocular, create11x11SignInsert, create17x17SignInsert };
